...
//   };
  ...
  return (
    <div ref={ref} className="bg-gray-50 py-20 overflow-hidden">
      <div className="container mx-auto px-6">
        <motion.div
          variants={containerVariants}
          initial="hidden"
          animate={controls}
          className="flex flex-col lg:flex-row items-center justify-center  mb-20"
        >
          {/* Left Content */}
          <motion.div
          ...
          >
            <motion.h2
              className="text-2xl lg:text-[32px] font-bold text-gray_text3 leading-tight"
            ...
            >
              ...
              relax knowing your furry friends are in safe hands. Whether it's a
              quick check-in or an extended stay, our app makes pet care simple
              and stress-free. Join a community of pet lovers today!
            </motion.p>
            ...
            <motion.h2
              className="lg:text-[20px] font-bold text-gray_text3 leading-tight"
              variants={textVariants}
            >
